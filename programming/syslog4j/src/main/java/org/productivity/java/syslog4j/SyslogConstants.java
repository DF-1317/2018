...
* @version $Id: SyslogConstants.java,v 1.27 2009/07/22 15:54:23 cvs Exp $
*/
public interface SyslogConstants extends Serializable {
	...
	public static final String STRUCTURED_DATA_MESSAGE_DATEFORMAT = "yyyy-MM-dd'T'HH:mm:ssZZ";
	...
	public static final int SHUTDOWN_INTERVAL = 100;
