...
public class SyslogMessageModifierTest extends AbstractNetSyslog4jTest {
	...
	public void testHTMLEntityEscapeMessageModifier() {
		...
		String nullHtml = messageModifier.modify(null,null,0,0,null);
		assertNull(nullHtml);
		
		String emptyHtml = messageModifier.modify(null,null,0,0,"");
		...
		syslog.getConfig().addMessageModifier(HTMLEntityEscapeSyslogMessageModifier.DEFAULT);
		
		// SEND HTML

		message = "[TEST] <html>&\"test\"&'" + "\t" + "</html>Ø";
		syslog.info(message);
